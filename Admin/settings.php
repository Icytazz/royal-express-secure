                                ...
                                <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == 'admin') : ?>
                                    <section class="row">
                                        ...
                                        ?>
                                            ...
                                            <img class="mt-2" width="200px" src='<?php echo e($img_src); ?>'>
                                            ...
                                            <img class="mt-2" width="200px" src='<?php echo e($imgs_src); ?>'>
                                            <form class="mt-3" method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                            ...
                                            <img class="mt-2" width="200px" src='<?php echo e($background_image_src); ?>'>
                ...
                <form action="" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                    <div class="modal-body bg-white">
                        <form action="" method="post" id="basicform" data-parsley-validate="">
                            ...
                            <div class="col-md-12 mt-3">
                                <input type="hidden" class="form-control" name="email" value="<?php echo e($_SESSION['admin']); ?>" id="email">
                            </div>
